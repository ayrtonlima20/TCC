angular.module("demo").controller("SprintReview", function($scope, historias, atividades, apontamento) {
	$scope.historias = {
		selected:null,
		options:[]
	};	
	...
	historias.get().success(function(data) {
		...
		$scope.getAtividades($scope.historias.selected.idHistoria);
		// $scope.fillTestes($scope.historias.selected.idHistoria, ativ.selected.idAtividade);
	});
